...
function displayStrategy() {
   if (availableStrategies.length === 0){
      card.textContent = "Over One Hundred Worthwhile Dilemmas";
      availableStrategies = [...strategies];
      return;
    }
   const randomIndex = Math.floor(Math.random() * availableStrategies.length);
   const strategy = availableStrategies[randomIndex];
   availableStrategies.splice(randomIndex, 1);
   card.textContent = strategy;
   }